...
public class WarlordsEvents implements Listener {
    ...
    public static void joinInteraction(Player player, boolean fromGame) {
        ...
        if (isSpawnWorld) {
            ...
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "" + ChatColor.BOLD + "您正在游玩 Warlords 2.0 " + ChatColor.GRAY + "(" + ChatColor.RED + Warlords.VERSION + ChatColor.GRAY + ")");
            ...
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "汉化翻译"+ ChatColor.RED +"by MC_tianci");
            ChatUtils.sendCenteredMessage(player, "");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "右键下界之星或使用" + ChatColor.GREEN + "/menu" + ChatColor.GOLD + "指令来打开菜单");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "你可以使用" + ChatColor.GREEN + "/start" + ChatColor.GOLD + "指令来开启私人游戏");
            ChatUtils.sendCenteredMessage(player, "");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "有关于本服务器最新的进展，锦标赛开启，与意见反馈");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "欢迎加入QQ群一起讨论:" + ChatColor.RED + "§l1013512012");
            ChatUtils.sendCenteredMessage(player, "");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "我们强烈建议你下载服务器材质包");
            ChatUtils.sendCenteredMessage(player, ChatColor.GOLD + "地址:" + ChatColor.RED + "§lhttps://wwd.lanzouy.com/idzeP035d7xc");
            ChatUtils.sendCenteredMessage(player, ChatColor.GRAY + "-----------------------------------------------------");
                    ...
                    case ALL:
                        ...
                        if (wp == null) {
                            e.setFormat(ChatColor.DARK_GRAY + "[" +
                                    ChatColor.GOLD + Specializations.getClass(playerSettings.getSelectedSpec()).name +
                                    ChatColor.DARK_GRAY + "][" +
