...
public enum PlayersCollections {
    ...
    LIFETIME("生涯", "Players_Information", "playersAllTime", LeaderboardCategory::getLifeTimeHolograms),
    ...
    WEEKLY("每周", "Players_Information_Weekly", "playersWeekly", LeaderboardCategory::getWeeklyHolograms),
    DAILY("每日", "Players_Information_Daily", "playersDaily", LeaderboardCategory::getDailyHolograms),
