...
public class DatabaseGameCTF extends DatabaseGameBase {
    ...
    public void createHolograms() {
        ...
        lastGameStats.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "上一局" + (isPrivate() ? "Comp" : "Pub") + "游戏统计");
        ...
        topDamage.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "最高伤害");
        ...
        topHealing.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "最高治疗");
        ...
        topAbsorbed.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "最高吸收");
        ...
        topDHPPerMinute.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "每分钟最高DHP");
        ...
        topDamageOnCarrier.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "最高伤害输出于旗手");
        ...
        topHealingOnCarrier.getLines().appendText(ChatColor.AQUA + ChatColor.BOLD.toString() + "最高治疗输出于旗手");
