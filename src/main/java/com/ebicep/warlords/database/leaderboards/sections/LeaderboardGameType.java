...
public abstract class LeaderboardGameType<T extends AbstractDatabaseStatInformation> {
    ...
    public void addBaseLeaderboards(LeaderboardCategory<T> leaderboardCategory) {
        ...
        leaderboards.add(new Leaderboard("胜利",
        ...
        leaderboards.add(new Leaderboard("失败", new Location(world, -2608.5, 52, 728.5),
        ...
        leaderboards.add(new Leaderboard("场数", new Location(world, -2564.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("击杀", new Location(world, -2552.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("助攻", new Location(world, -2616.5, 52, 733.5),
        ...
        leaderboards.add(new Leaderboard("死亡", new Location(world, -2616.5, 52, 723.5),
        ...
        leaderboards.add(new Leaderboard("伤害量", new Location(world, -2600.5, 52, 723.5),
        ...
        leaderboards.add(new Leaderboard("治疗量", new Location(world, -2608.5, 52, 719.5),
        ...
        leaderboards.add(new Leaderboard("吸收量", new Location(world, -2600.5, 52, 733.5),
        ...
        leaderboards.add(new Leaderboard("经验值", new Location(world, -2526.5, 57, 744.5),
